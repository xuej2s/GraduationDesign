						...
						<div class="col-xs-12">
							...
							<div
								...
								<a class="blue" href="<%=basePath%>admin/addcourse.do"> <i
									...
									href="<%=basePath %>admin/updateactivity.do?courseId=${a.courseId}&courseName=${a.courseName}&startTime=${a.startTime}&
															endTime=${a.endTime}&weekend=${a.weekend}&courseCost=${a.courseCost}">
									<i class="icon-pencil bigger-130"></i>
								</a> <a class="red"
									href="<%=basePath %>admin/deleteactivity.do?courseId=${a.courseId}">
