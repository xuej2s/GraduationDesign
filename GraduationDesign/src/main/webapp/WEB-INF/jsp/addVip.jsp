				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" action="<%=basePath%>admin/addVip.do" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="vipName" name="vipName"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-select-1">性别</label>
									<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5" id="vipSex"
											name="vipSex">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="vipTel" name="vipTel"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="space-4"></div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-select-1">会员类型</label>
									<div class="col-sm-9">
